...
const (
	internalKeyKindDelete  = base3.InternalKeyKindDelete
	internalKeyKindSet     = base3.InternalKeyKindSet
	internalKeyKindInvalid = base3.InternalKeyKindInvalid

	internalKeySeqNumMax = base3.InternalKeySeqNumMax
)
